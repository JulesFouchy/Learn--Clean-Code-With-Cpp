...
Welcome ! In this section you will be able to see your progress live, your current grade, and the next skills that you can learn. Each student as his/her own page which I will update regularly with the skills that I have validated.
...
Please check the skills that you consider to master already, then export them as json using that big green button and send them to me.

If you have a doubt, don't check the skill ; in the worst case this will mean that you will have a skill that is easy to validate during the semester.
